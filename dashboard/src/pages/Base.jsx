...
export default function Base() {
    ...
    return (
        <section className="section active">
            ...
            <p className="section-subtitle">Attacker wallet on Base — previously active, now largely drained to Ethereum.</p>
            ...
            <div className="card">
                ...
                <div className="stats-grid">
                    <div className="stat-card cyan">
                        ...
                        <div className="stat-detail">{base.note || 'ETH only'}</div>
                    </div>
                </div>
