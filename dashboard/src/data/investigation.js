...
export const STATS = {
    ...
    drainedUsdc: '~$1M USDC',
    frozenXlm: '~48M XLM (main + Swap Hub + Funder/Ops — confirmed mootz12)',
    netExtraction: '~$3M gross off-chain value',
    usdcBridged: '~$997.7K USDC (direct borrow, bridged immediately)',
    xlmConverted: '~5M XLM → $787,167 USDC (via GATDQL + 4 throwaway accts)',
    xlmToBinance: '3,769,756 XLM to Binance (Relay 3.54M + Small 234K) — has KYC',
    xlmToChangeNow: '3,965,831 XLM to ChangeNow (no KYC!) — changenow.io',
    slippageBurn: '2.6% below spot ($0.1565/XLM effective vs $0.16065 spot)',
    spotPriceAtExploit: '$0.16065/XLM (ledger 61340408, DEX candle 00:24 UTC)',
    effectiveRate: '$0.1565/XLM blended (confirmed from 3 path_payment ops)',
    bridgedToBase: '~$787K',
    bridgedToEth: '~$172K',
    bridgedToBsc: '~$38.7K',
    recovered: '$0.00',
...
export const BRIDGE_STATUS = {
    lastUpdate: 'Feb 22, 2026 ~8:35 PM EST',
    source: 'mootz12 (Blend core team) + Horizon deep dive',
    xlmFrozen: '45,068,299 XLM (main wallet)',
    xlmInIntermediaries: '~3,609,715 XLM (6 wallets)',
    xlmConverted: '~5M XLM → $787,167 USDC (GATDQL + 4 throwaway accts)',
    xlmToBinanceRaw: '3,600,610 XLM sent raw to Binance (not converted)',
    usdcBorrowedDirect: '~$1M USDC (borrowed directly, bridged immediately)',
    usdcBridgedOut: '~$997.7K USDC (direct borrow: Base $787K + ETH $172K + BSC $38.7K)',
    usdcFromXlm: '$787,167 USDC (from ~5M XLM, 16 Soroban bridge calls → Base)',
    totalOffChain: '~$1.78M USDC total',
    spotPrice: '~$0.161/XLM at exploit',
    effectiveRate: '$0.1565/XLM avg (~3% slippage)',
    negotiations: true,
