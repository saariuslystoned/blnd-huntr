...
export const BRIDGE_STATUS = {
    ...
    xlmToChangeNow: '3.97M XLM',
    xlmToChangeNowDetail: 'ChangeNow (no KYC!) — changenow.io',
    xlmConverted: '~5M XLM → 1,414,244 USDC',
    xlmConvertedDetail: 'via GATDQL + 4 throwaway accts, 15 bridge calls to Base + 12 to Ethereum + 1 to BSC',
    usdcBridgedOut: '1,414,244.95 USDC',
    usdcBridgedDetail: 'Audited: Base 788,524 USDC (15 batches) + ETH 586,974 USDC (12 batches) + BSC 38,746 USDC (1 batch)',
    totalOffChain: '~$3.4M',
    totalOffChainDetail: '1.41M USDC bridged to EVM (~$1.41M) + 7.74M XLM to exchanges (~$1.21M) + ~4.7M XLM frozen on Stellar (~$752K)',
    negotiations: true,
    negotiationsNote: 'Bounty offer sent — attacker declined. Laundering continued.',
    negotiationAccount: 'GBCAS7XIGDRZY4BMABJMGGW7J3YTITRRV5BTEMFQE5ZZSSVWHHX2ZSS4',
    negotiationAccountLabel: 'Blend Security Council',
    negotiationTimeline: [
        { time: 'Feb 22 · 21:26 UTC', action: 'Security Council sends initial payment to attacker (setup)', memo: null },
        { time: 'Feb 22 · 21:35 UTC', action: 'Security Council signals intent via Stellar memo', memo: 'sending etherscan message' },
        { time: 'Feb 22 · 21:58 UTC', action: 'Bounty offer sent (encoded hash memo #1)', memo: 'hash' },
        { time: 'Feb 22 · 22:03 UTC', action: 'Follow-up terms sent (encoded hash memo #2)', memo: 'hash' },
        { time: 'Feb 22 · 22:06 UTC', action: 'Final offer sent (encoded hash memo #3)', memo: 'hash' },
        { time: 'Feb 23 · 09:01 UTC', action: 'Attacker ignores offer — begins bridging 380 ETH from Base to Ethereum', memo: null },
    ],
};
